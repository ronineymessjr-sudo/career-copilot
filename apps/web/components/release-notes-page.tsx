...
export function ReleaseNotesPage() {
  ...
  return <main className="release-page">
    ...
    <footer className="release-footer"><span>Career Copilot · Evidence-driven AI internship operating system</span><span><Link href="/privacy">隐私边界</Link> <Link href="/playground">回到公开体验 <ArrowRight size={14}/></Link></span></footer>
  </main>;
}
