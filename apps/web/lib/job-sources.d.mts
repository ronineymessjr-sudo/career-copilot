...
export type JobSourceRecord = { id: string; user_id: string; name: string; provider: JobSourceProvider; identifier: string; enabled?: boolean; scope?: "private" | "shared"; filters?: Record<string, unknown> | null };
