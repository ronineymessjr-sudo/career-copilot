...
export function evaluateJob(job: Record<string, unknown>, evidence?: Array<Record<string, unknown>>, today?: Date): Evaluation;
export function buildApplicationPackage(job: Record<string, unknown>, evaluation: Evaluation, evidence?: Array<Record<string, unknown>>, resumeVersions?: Array<Record<string, unknown>>): Record<string, unknown>;
