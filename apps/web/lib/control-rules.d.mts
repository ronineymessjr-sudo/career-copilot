...
export function buildApplicationPackage(job: Record<string, unknown>, evaluation: Record<string, any>, evidence?: Array<Record<string, unknown>>, resumeVersions?: Array<Record<string, unknown>>, options?: { selected_resume_id?: string; profile?: Record<string, unknown> }): Record<string, unknown>;
