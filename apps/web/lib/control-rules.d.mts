...
export function buildApplicationPackage(job: Record<string, unknown>, evaluation: Record<string, any>, evidence?: Array<Record<string, unknown>>, resumeVersions?: Array<Record<string, unknown>>, options?: { selected_resume_id?: string | null; profile?: Record<string, unknown>; account_email?: string | null }): Record<string, unknown>;
