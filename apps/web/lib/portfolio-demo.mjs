...
export const DEMO_SCENARIOS = Object.freeze([
  ...
  },
  {
    ...
    label: "法学/合规实习",
    note: "合同、合规与证据整理",
    jd: `法律科技与合规实习生（南京/可远程）\n职责：协助合同条款审查、隐私合规资料整理、案例检索和法律文书校对，形成可追溯的证据清单。\n要求：在校本科生，接受2028届；每周至少3天，至少3个月；具备法律检索、合同法或数据合规基础。`,
  },
  {
    id: "operations-growth",
    label: "运营/增长实习",
    note: "内容、活动与数据复盘",
    jd: `用户运营与增长实习生（南通/可远程）\n职责：参与内容选题、活动执行、用户反馈整理和增长数据复盘，协同产品团队推进迭代。\n要求：在校本科生，接受2028届；每周至少3天，至少3个月；熟悉表格、指标分析和沟通协作。`,
  },
  {
    id: "photo-video",
    label: "摄影/摄像实习",
    note: "拍摄、剪辑与作品集交付",
    jd: `摄影摄像与后期实习生（南通/可远程）\n职责：完成产品与人物拍摄、短视频剪辑、调色修图和内容脚本，按项目节点交付作品集素材。\n要求：在校本科生，接受2028届；每周至少3天，至少3个月；熟悉相机、Premiere、Photoshop或同类工具。`,
  },
  {
    id: "ai-research",
    label: "AI 研究/算法实习",
    note: "Transformer、实验与评测",
    jd: `机器学习与 AI 研究实习生（南京/混合）\n职责：参与 Transformer、深度学习模型实验、论文复现、数据处理和离线评测，记录可复现的实验结论。\n要求：在校本科生，接受2028届；每周至少3天，至少3个月；熟悉 Python、机器学习和实验设计。`,
  },
  {
    id: "traditional-rnd",
    label: "传统科研/制造研发",
    note: "材料、工艺与实验记录",
    jd: `材料与制造研发实习生（南通崇川/混合）\n职责：协助材料性能实验、工艺参数记录、质量数据整理和研发报告撰写，支持实验室与产线协作。\n要求：在校本科生，接受2028届；每周至少3天，至少3个月；具备材料、机械或制造基础，重视安全与记录。`,
  },
  {
    id: "data-analytics",
    label: "数据分析实习",
    note: "指标、SQL 与业务洞察",
    jd: `商业数据分析实习生（可远程）\n职责：使用 SQL、Python 和可视化工具搭建指标看板，完成 A/B 测试分析并输出业务洞察和复盘报告。\n要求：在校本科生，接受2028届；每周至少3天，至少3个月；具备数据清洗、统计分析和沟通能力。`,
  },
  {
    id: "solutions-sales",
    label: "方案/售前实习",
    note: "竞品、客户与交付协作",
    jd: `AI 解决方案与售前实习生（南京/混合）\n职责：参与客户需求访谈、竞品分析、解决方案撰写、演示材料准备和项目交付跟进。\n要求：在校本科生，接受2028届；每周至少3天，至少3个月；具备结构化表达、数据分析和跨团队协作能力。`,
  },
  {
    id: "remote-hr",
    label: "远程招聘运营",
    note: "候选人沟通与流程维护",
    jd: `远程招聘运营实习生（可远程）\n职责：协助职位发布、候选人沟通、面试排期、招聘数据统计和流程文档维护，保护候选人隐私。\n要求：在校本科生，接受2028届；每周至少3天，至少3个月；细心，善于沟通并熟悉表格工具。`,
  },
  {
    id: "remote-backend",
    label: "远程后端实习",
