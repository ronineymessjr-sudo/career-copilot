export const PUBLIC_RELEASE_NOTES = Object.freeze([
  {
    ...
    title: "批量筛选与来源新鲜度",
    date: "2026-08",
    summary: "把薪资、风险词、公司年份、重复岗位和岗位发布时间纳入同一条可解释演练链路，并让不同职业方向都能先用对应档位试跑。",
    highlights: ["区间重叠与完全包含两种薪资匹配策略", "来源缺少发布时间或历史记录时明确标记待核验", "新增法学、运营、摄影、AI 研究、传统研发、数据、方案和远程招聘场景", "批量筛选只预览节奏，不执行点击、发送或投递"],
  },
  {
    version: "M08.1",
    title: "证据化投递工作台",
